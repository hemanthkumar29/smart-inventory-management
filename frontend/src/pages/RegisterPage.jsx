  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="card-surface w-full max-w-md p-6">
        ...
        <h1 className="mt-2 text-2xl font-bold text-brand-900">Create your account</h1>

        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          <ErrorMessage message={error} />

          <div>
            <label className="mb-1 block text-sm font-medium text-brand-700" htmlFor="name">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-brand-700" htmlFor="companyName">
              Enterprise Name
            </label>
            <input
              id="companyName"
              ...
              onChange={handleChange}
            />
            <p className="mt-1 text-xs text-brand-500">Required when creating a new enterprise workspace</p>
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-brand-700" htmlFor="companyCode">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <p className="mt-1 text-xs text-brand-500">Enter this to join an existing enterprise. If provided, you will join as staff.</p>
          </div>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-brand-700" htmlFor="confirmPassword">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
