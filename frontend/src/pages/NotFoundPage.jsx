...
const NotFoundPage = () => (
  <div className="flex min-h-screen items-center justify-center p-4">
    <div className="card-surface max-w-lg p-8 text-center">
      ...
      <h1 className="mt-2 text-3xl font-bold text-brand-900">Page not found</h1>
      <p className="mt-2 text-sm text-brand-600">The route you are looking for does not exist.</p>
